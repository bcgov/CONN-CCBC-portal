...
select is((select sub from ccbc_public.session()), '22222222-2222-2222-2222-222222222222'::VARCHAR, 'The session sub is determined by the jwt.claims.idir_userid setting if it exists');
