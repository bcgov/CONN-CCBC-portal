...
-- Insert project information data (funding agreement)
...
-- Insert SOW Tab 1 data (households impacted)
...
-- Insert SOW Tab 2 data
insert into ccbc_public.sow_tab_2
(json_data, sow_id, created_by, created_at, updated_by, updated_at)
overriding system value
values
('{"projectDescription": "SOW project description"}',
1, 1, '2022-10-17 16:28:11.006719-07', 1, '2022-10-17 16:28:26.105206-07');

-- Insert SOW Tab 7 data (funding summary)
insert into ccbc_public.sow_tab_7
(json_data, sow_id, created_by, created_at, updated_by, updated_at)
overriding system value
values
('{"summaryTable": {"amountRequestedFromProvince": 650000, "amountRequestedFromFederalGovernment": 350000, "totalFundingRequestedCCBC": 1000000, "totalApplicantContribution": 300000, "totalInfrastructureBankFunding": 0, "totalFNHAFunding": 75000, "fundingFromAllOtherSources": 25000, "totalProjectCost": 1400000}}',
1, 1, '2022-10-17 16:28:11.006719-07', 1, '2022-10-17 16:28:26.105206-07');

-- Insert SOW Tab 8 data (community details)
insert into ccbc_public.sow_tab_8
(json_data, sow_id, created_by, created_at, updated_by, updated_at)
overriding system value
values
('{"communitiesNumber": 8, "indigenousCommunitiesNumber": 3, "geoNames": [{"bcGeoName": "SOW Community 1", "geoNameId": "3001", "indigenous": "N", "impacted": "YES", "mapLink": "http://example.com/sowmap1"}, {"bcGeoName": "SOW Indigenous Community 1", "geoNameId": "3002", "indigenous": "Y", "impacted": "YES", "mapLink": "http://example.com/sowmap2"}, {"bcGeoName": "SOW Community 2", "geoNameId": "3003", "indigenous": "N", "impacted": "YES", "mapLink": "http://example.com/sowmap3"}]}',
1, 1, '2022-10-17 16:28:11.006719-07', 1, '2022-10-17 16:28:26.105206-07');

-- Insert FNHA contribution data
insert into ccbc_public.application_fnha_contribution
(application_id, fnha_contribution, created_by, created_at, updated_by, updated_at)
overriding system value
values
(1, 75000, 1, '2022-10-17 16:28:11.006719-07', 1, '2022-10-17 16:28:26.105206-07');
