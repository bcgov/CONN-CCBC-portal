...
-- Insert project information data (funding agreement) - but no date signed
insert into ccbc_public.project_information_data
(json_data, application_id, created_by, created_at, updated_by, updated_at)
overriding system value
values
('{"projectDescription": "Project without SOW data"}',
1, 1, '2022-10-17 16:28:11.006719-07', 1, '2022-10-17 16:28:26.105206-07');

-- Note: No SOW data is inserted - this should trigger the error messages
