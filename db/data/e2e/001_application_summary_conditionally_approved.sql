...
overriding system value
values
(1,'conditionally_approved',1,'2022-10-17 10:16:45.319172-07');
...
values
(1,
'{"submission": {"submissionDate": "2022-10-09", "submissionCompletedFor": "Test org name", "submissionCompletedBy": "Test Applicant", "submissionTitle": "Summary Test Conditionally Approved"}, "projectInformation": {"projectTitle": "Summary Test Application - Conditionally Approved Status"}, "review": {"acknowledgeIncomplete": true}, "organizationProfile": {"organizationName": "Test org name"}, "projectFunding": {"totalFundingRequestedCCBC": 1000000, "totalApplicantContribution": 250000}, "budgetDetails": {"totalProjectCost": 1250000}, "otherFundingSources": {"otherFundingSourcesArray": [{"totalRequestedFundingPartner": 50000, "fundingPartner": "Test Partner"}]}, "projectPlan": {"projectStartDate": "2023-01-01", "projectCompletionDate": "2024-12-31"}, "benefits": {"numberOfHouseholds": 500, "householdsImpactedIndigenous": 150}, "acknowledgements": {"acknowledgementsList": ["The Applicant acknowledges that it is under no obligation or prohibition, nor is it subject to, or threatened by any actions, suits or proceedings, which could or would affect its ability to implement this proposed Project."]}}',
'projectInformation',
...
(application_id, json_data, created_by, created_at, updated_by, updated_at)
overriding system value
values
(1,
'{
    ...
    "response": {
        ...
        "statusApplicantSees": "conditionally_approved"
    },
    "isedDecisionObj": {
...
}', 1, '2022-10-17 16:28:11.006719-07', 1, '2022-10-17 16:28:26.105206-07');
