...
delete from ccbc_public.application_announcement;
delete from ccbc_public.announcement;
...
insert into ccbc_public.announcement
(id, json_data, created_by, created_at, updated_by, updated_at)
overriding system value
values
(1, '{"announcementType": "Primary", "announcementDate": "2023-01-15", "announcementUrl": "http://example.com/announcement"}', 1, '2022-10-17 16:28:11.006719-07', 1, '2022-10-17 16:28:26.105206-07');

-- Link announcement to application
insert into ccbc_public.application_announcement
(announcement_id, application_id, is_primary, created_by, created_at, updated_by, updated_at)
overriding system value
values
