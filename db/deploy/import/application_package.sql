...
as $function$
    declare
        ...
        record_id       uuid;  
    begin
    delete from ccbc_public.record_version where table_name='application_package' and op='INSERT';
    ...
    open application_packages for select *
		    from ccbc_public.application_package where archived_by is null;
