...
begin
  update ccbc_public.application_merge set archived_at = now() where child_application_id = _child_application_id and archived_at is null returning * into archived_merge;
