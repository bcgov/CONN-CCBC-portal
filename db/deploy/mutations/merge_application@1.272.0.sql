...
grant execute on function ccbc_public.merge_application to ccbc_analyst;
grant execute on function ccbc_public.merge_application to ccbc_admin;
grant execute on function ccbc_public.merge_application to cbc_admin;
