...
const ReadOnlyProjectAreaWidgetIntakeFive: React.FC<WidgetProps> = () => {
  return (
    <>
      <StyledError>
        IMPORTANT: For Intake 5, CCBC will accept applications for all eligible
...
export default ReadOnlyProjectAreaWidgetIntakeFive;
