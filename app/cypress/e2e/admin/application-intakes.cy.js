...
describe('The admin Application intakes page', () => {
  ...
  it('Create intake start date and end date must be after current date and time', () => {
    ...
    cy.wait('@graphql');
    cy.contains('button', /Add intake/).click();
    cy.get('input[id="root_startDate"]').type('2023-10-07 00:00 AM');
    cy.get('input[id="root_endDate"]').type('2023-10-07 00:00 AM');
  ...
  it('Create Intake', () => {
    ...
    cy.contains('h2', 'Application Intakes');
    cy.contains('button', /Add intake/).click();
    cy.get('input[id="root_startDate"]').type('2023-11-01 00:00 AM');
    cy.get('input[id="root_endDate"]').type('2023-12-30 00:00 AM');
