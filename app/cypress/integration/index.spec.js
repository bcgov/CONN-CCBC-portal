...
context('Homepage', () => {
  ...
  it('should start and fill the first page of the form', () => {
    ...
    cy.waitUntil(() => cy.url().should('contain', '/form/1'));
    ...
    // Project area page
    cy.waitUntil(() => cy.url().should('contain', '/form/2'));
    ...
    cy.waitUntil(() => cy.url().should('contain', '/form/3'));
    cy.waitUntil(() =>
    ...
    // // Budget details page
    cy.waitUntil(() => cy.url().should('contain', '/form/4'));
    cy.waitUntil(() =>
    ...
    cy.waitUntil(() => cy.url().should('contain', '/form/5'));
    cy.waitUntil(() =>
    ...
    cy.waitUntil(() => cy.url().should('contain', '/form/6'));
    cy.waitUntil(() =>
    ...
    cy.waitUntil(() => cy.url().should('contain', '/form/7'));
    cy.waitUntil(() =>
    ...
    cy.waitUntil(() => cy.url().should('contain', '/form/8'));
    ...
    cy.waitUntil(() => cy.url().should('contain', '/form/9'));
    cy.waitUntil(() =>
      cy
        .get('h1')
