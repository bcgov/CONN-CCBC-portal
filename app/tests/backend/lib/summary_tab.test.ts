...
describe('sow_summary parsing tests', () => {
  ...
  it('return errors for invalid worksheet', async () => {
    ...
    const expected = {
      "error":
      [
        {"level":"cell","error":"Invalid data: Last Mile Technologies - Fibre"},
        {"level":"cell","error":"Invalid data: Last Mile Technologies - Cable"},
        {"level":"cell","error":"Invalid data: Last Mile Technologies - DSL"},
        {"level":"cell","error":"Invalid data: Last Mile Technologies - Mobile Wireless"},
        {"level":"cell","error":"Invalid data: Last Mile Technologies - Fixed Wireless"},
        {"level":"cell","error":"Invalid data: Last Mile Technologies - Satellite"},
        {"level":"cell","error":"Invalid data: Effective Start Date"},
        {"level":"cell","error":"Invalid data: Project Start Date"},
        {"level":"cell","error":"Invalid data: Project Completion Date"},
        {"level":"cell","error":"Invalid data: Applicant Name"},
        {"level":"cell","error":"Invalid data: Project Title"},
        {"level":"cell","error":"Invalid data: Province"}
      ]
    };
