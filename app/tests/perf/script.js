...
const binFile = open('../../../k6Results/file2.bin', 'b');
...
//     uploads: {
//       executor: 'shared-iterations',
//       vus: 1, // 50 user looping for 1000 iterations
//       iterations: 100,
//     },
//   },
//   thresholds: {
...
export default function () {
  ...
  if (exec.scenario.name === 'uploads') {
    const file = http.file(binFile, 'file.bin');
    ...
    fd.append('map', '{ "0": ["variables.input.attachment.file"] }');
    fd.append(0, file);
