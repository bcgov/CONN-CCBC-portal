...
const ReviewBooleanField: React.FC<FieldProps> = ({
  id,
  formData,
  rawErrors,
  schema,
  ...
  return (
    <tr>
      ...
      {rawErrors && rawErrors.length > 0 ? (
        ...
        <StyledColRight id={`${id}-value`}>{displayValue}</StyledColRight>
      )}
    </tr>
  );
};

export default ReviewBooleanField;
